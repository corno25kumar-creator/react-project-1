...
function Todo({ title, description, startDate, endDate }) {
  return (
    <div className="relative bg-green-500 rounded-lg p-4 flex flex-col gap-4 w-64 shadow-md">
      ...
      <div className="absolute bottom-2 left-2 flex gap-4 border-2 border-gray-300 p-2 rounded-lg bg-white">
        <RiEdit2Fill className="text-lg sm:text-xl md:text-2xl text-green-600" />
        <RiDeleteBin5Fill className="text-lg sm:text-xl md:text-2xl text-red-600" />
      </div>
    </div>
  );
}
